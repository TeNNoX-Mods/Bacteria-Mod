...
public class BacteriaCommonProxy {
	...
	public void init(FMLInitializationEvent event) {
		...
		// Achievements
		Bacteria.mustAchievement = new Achievement("bacteriamod.must", "must", 5, -2, Bacteria.must, AchievementList.buildWorkBench).registerAchievement();
		Bacteria.bacteriaAchievement = new Achievement("bacteriamod.bacteria", "bacteria", 5, -3, Bacteria.bacteriaBunch, Bacteria.mustAchievement).registerAchievement();
		Bacteria.bacteriumAchievement = new Achievement("bacteriamod.bacterium", "bacterium", 5, -4, Bacteria.bacteria, Bacteria.bacteriaAchievement)
				.setSpecial().registerAchievement();
		Bacteria.jamAchievement = new Achievement("bacteriamod.jammer", "jammer", 5, -5, Bacteria.jammerItem, Bacteria.bacteriumAchievement)
				.setSpecial().registerAchievement();
